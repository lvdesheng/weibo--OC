...
#import "LVtest1ViewController.h"

@interface LVMeViewController ()

@end

@implementation LVMeViewController
...
- (void)setting
{
    LVtest1ViewController *test1 = [[LVtest1ViewController alloc]init];
    test1.title = @"test1";
